function send_request_setpoints(program_status, home, SCADA_receive,SCADA_send, IEDnames,setpointnames,setpoints)
%[] = send_request_setpoints(program_status, home, SCADA_receive,SCADA_send, IEDnames,setpointnames,setpoints)
% send SCADA a list of IED's, parameters, and setpoints for communication
% to devices. 
