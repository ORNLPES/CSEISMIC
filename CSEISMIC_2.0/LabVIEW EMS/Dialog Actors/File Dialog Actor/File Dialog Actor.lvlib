...
<Library LVVersion="18008000">
	...
	<Item Name="Abstract Messages for File Dialog Actor" Type="Folder">
		<Item Name="Return File Path Msg.lvclass" Type="LVClass" URL="../File Dialog Messages/Return File Path Msg/Return File Path Msg.lvclass"/>
	</Item>
	<Item Name="File Dialog.lvclass" Type="LVClass" URL="../File Dialog/File Dialog.lvclass"/>
</Library>
