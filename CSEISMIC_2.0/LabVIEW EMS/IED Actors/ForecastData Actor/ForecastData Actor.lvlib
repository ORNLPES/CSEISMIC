...
<Library LVVersion="18008000">
	...
	<Item Name="Messages for ForecastData Actor" Type="Folder">
		<Item Name="Write ForecastData_Long Msg.lvclass" Type="LVClass" URL="../ForecastData Messages/Write ForecastData_Long Msg/Write ForecastData_Long Msg.lvclass"/>
	</Item>
	<Item Name="ForecastData.lvclass" Type="LVClass" URL="../ForecastData/ForecastData.lvclass"/>
</Library>
