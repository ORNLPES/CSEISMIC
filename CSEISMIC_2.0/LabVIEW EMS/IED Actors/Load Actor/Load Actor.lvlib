...
<Library LVVersion="18008000">
	...
	<Item Name="Messages for Load Actor" Type="Folder">
		<Item Name="Write Load Control Msg.lvclass" Type="LVClass" URL="../Load Messages/Write Load Control Msg/Write Load Control Msg.lvclass"/>
	</Item>
