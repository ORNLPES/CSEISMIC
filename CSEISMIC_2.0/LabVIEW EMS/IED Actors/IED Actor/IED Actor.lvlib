...
<Library LVVersion="18008000">
	...
	<Item Name="Messages for IED Actor" Type="Folder">
		<Item Name="Set Microgrid ID Msg.lvclass" Type="LVClass" URL="../IED Messages/Set Microgrid ID Msg/Set Microgrid ID Msg.lvclass"/>
		<Item Name="Watchdog Reset Msg.lvclass" Type="LVClass" URL="../IED Messages/Watchdog Reset Msg/Watchdog Reset Msg.lvclass"/>
		<Item Name="Set Single Device Microgrid ID Msg.lvclass" Type="LVClass" URL="../IED Messages/Set Single Device Microgrid ID Msg/Set Single Device Microgrid ID Msg.lvclass"/>
	</Item>
